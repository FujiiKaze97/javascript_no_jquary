...
// thisData에 reviewData 에서 카드 클릭시 적용되는innerhtml 값을 가져와야함.

const thisData = reviewData.find((review) =>
  review.name === document.getElementById('review_id') &&
  review.content === document.getElementById('review_id') &&
  review.score.toString() === document.getElementById('review_star'))

// const thisData = document.getElementById('review_id')
